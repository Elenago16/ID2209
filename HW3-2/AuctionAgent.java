...
public class AuctionAgent extends Agent  {
    ...
    private class ManagerBehaviour extends OneShotBehaviour {
        ...
        public void action() {
            ...
            try {
                c1.createNewAgent(museums[0] + "_Profiler1", "ProfilerAgent", 
                        new Object[0]).start();
                c2.createNewAgent(museums[1] + "_Profiler1", "ProfilerAgent", 
                        new Object[0]).start();
    ...
    private class determineWinningBid extends ParallelBehaviour {
        ...
        @Override
        public int onEnd() {
            if(!isClone) System.out.println("The winning bid is: " + bid);
            return 0;
        }    
    }
